...
const TbAnak = () => {
    return (
        <>
            <SEO
                title="Tuberkulosis Anak - Panduan untuk Orang Tua"
                description="Panduan komprehensif tuberkulosis pada anak untuk orang tua. Pelajari gejala, diagnosis, pengobatan, dan cara merawat anak dengan TB."
                keywords="tuberkulosis anak, TB anak, gejala TB anak, pengobatan TB anak, merawat anak TB"
                url="https://tbcare.vercel.app/materi/tuberkulosis_anak"
                type="article"
            />
            <Box
                id="materi"
