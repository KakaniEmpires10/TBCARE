...
const TbDewasa = () => {
    return (
        <>
            <SEO
                title="Tuberkulosis Dewasa - Panduan Lengkap"
                description="Panduan lengkap tuberkulosis pada dewasa meliputi gejala, diagnosis, pengobatan, dan pencegahan. Pelajari cara mengenali dan mengatasi TB dewasa."
                keywords="tuberkulosis dewasa, TB dewasa, gejala TB dewasa, pengobatan TB dewasa, diagnosis tuberkulosis"
                url="https://tbcare.vercel.app/materi/tuberkulosis_dewasa"
                type="article"
            />
            <Box
                id="materi"
